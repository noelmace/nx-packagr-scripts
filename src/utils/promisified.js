/// Take every error-first callback style dependencies, and export them in a version that returns promises
/// using Node 8 LTS Util.promisify : https://nodejs.org/docs/latest-v8.x/api/util.html
